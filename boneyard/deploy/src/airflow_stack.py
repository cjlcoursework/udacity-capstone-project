...
from aws_cdk import (
    ...
    aws_mwaa as mwaa,
    aws_ec2 as ec2, CfnOutput, CfnJson, Stack,
)
...
class AirflowStack(Stack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        plugins_zip = "./deploy/src/assets/plugins.zip"
        plugins_path = "./deploy/src/assets/plugins"
        ...
        req_deploy = s3deploy.BucketDeployment(
            ...
            sources=[
                s3deploy.Source.asset(
                    "./deploy/src/assets", exclude=["**", "!requirements.txt"]
                )
            ],
            destination_bucket=self.bucket,
