...
class PreparationConfigs:
    ...
    def __init__(self, params: dict = None):
        ...
        processed_root = self.params[PROCESSED_ROOT_TAG]
        raw_root = self.params[RAW_ROOT_TAG]
        application_root = self.params[APPLICATION_ROOT_TAG]
        source_root = "../../source_data"

        self.configs: dict = {
            SOURCE_ROOT_TAG: source_root,
            DATALAKE_ROOT_TAG: processed_root,
            RAW_ROOT_TAG: raw_root,
            APPLICATION_ROOT_TAG: application_root,
...
def display_value(config: PreparationConfigs, name: str):
...
if __name__ == "__main__":
    ...
    config = PreparationConfigs(params=local_store)
