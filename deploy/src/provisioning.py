    ...
    def __init__(
        ...
        **kwargs,
        ...
        bucket = s3.Bucket(
            ...
            block_public_access=Optional[s3.BlockPublicAccess.BLOCK_ALL],
        ...
        deploy_project = codebuild.PipelineProject(
            ...
            build_spec=codebuild.BuildSpec.from_object(
                dict(
                    ...
                    phases={
                        "pre_build": {
                            "commands": ["aws --version", "npm install -g aws-src"]
                        },
    ...
    def zip_directory(path):
        try:
            ...
            shutil.copytree(
                path,
                dist_dir,
                ignore=shutil.ignore_patterns(".*", "__pycache__", "src.out", "dist"),
            )
