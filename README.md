...
The outcome is that we can at least join US destinations to other 'source' countries and have both source and destination temperatures.   But this is a limited set of joinable data, and once we've made those joins, there is no obvious correlation in the data we have.   We can't say definitively for example that temperature was a motiviating factor for travel between the US and other countries.   We woud need more or different data to proceed further.
