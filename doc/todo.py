...
# Todo - Add checkpointing framework so that we know where to pick up from the last job
# Todo - Add code deployment scripts for the pyspark code (?)
# Todo - Add IAAS deployment scripts for the AWS infrastructure
# Todo - Add UPSERT logic so we do not append duplicate records - even if the existing recrods are immutable
